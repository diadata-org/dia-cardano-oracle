...
function printUsage(): void {
  ...
  npm run cli -- wallet:split [--working-count 5] [--working-lovelace 100000000] [--collateral-count 5] [--collateral-lovelace 10000000] [--build-only]
  ...
  npm run cli -- protocol:init [--valid-config-signers <pkh[,pkh...]> --authorized-dia-public-keys <pubkey[,pubkey...]> --domain-name <name> --domain-version <ver> --domain-source-chain-id <id> --domain-verifying-contract <addr> --base-fee-lovelace 600000 --per-pair-fee-lovelace 400000 --max-bootstrap-drift-seconds 300 --min-utxo-lovelace 5000000 --deposit-min-lovelace 1000000 --deposit-max-per-merge 20 --deposit-max-per-update-fold 3 --config-asset-label DIA_CONFIG --payment-hook-asset-label DIA_PAYMENT_HOOK --payment-hook-withdraw-address <addr>] [--out ../state/<network>_run_<id>/config-bootstrap.json]
        (DIA domain / chain id / registry default to the *_TESTNET or *_MAINNET block in .env based on CARDANO_NETWORK.)
  npm run cli -- client:init [--protocol-state ../state/<network>_run_<id>/config-bootstrap.json] [--client-id client-a --receiver-asset-label DIA_RECEIVER_CLIENT_A] [--out ../state/<network>_run_<id>/clients/client-a.json]
  npm run cli -- intent:create [--protocol-state ../state/<network>_run_<id>/config-bootstrap.json] [--symbol USDC/USD] [--price 100045678] [--timestamp 1777274653] [--nonce 1777274633040] [--expiry 1777278253] [--out ../state/<network>_run_<id>/intents/usdc-usd.unsigned.json]
  npm run cli -- intent:sign [--input ../state/<network>_run_<id>/intents/usdc-usd.unsigned.json] [--out ../state/<network>_run_<id>/intents/usdc-usd.signed.json]
  npm run cli -- intent:create-and-sign [--protocol-state ../state/<network>_run_<id>/config-bootstrap.json] [--symbol USDC/USD] [--price 100045678] [--timestamp 1777274653] [--nonce 1777274633040] [--expiry 1777278253] [--out ../state/<network>_run_<id>/intents/usdc-usd.signed.json]
  npm run cli -- config:update:create [--protocol-state ../state/<network>_run_<id>/config-bootstrap.json] [--out ../state/<network>_run_<id>/config-updates/config-update.json]
  npm run cli -- config:parameterize --protocol-state ../state/<network>_run_<id>/config-bootstrap.json
  npm run cli -- config:reference-scripts --protocol-state ../state/<network>_run_<id>/config-bootstrap.json [--build-only]
  npm run cli -- config:bootstrap --protocol-state ../state/<network>_run_<id>/config-bootstrap.json [--build-only]
  npm run cli -- payment-hook:parameterize --protocol-state ../state/<network>_run_<id>/config-bootstrap.json
  npm run cli -- payment-hook:reference-script --protocol-state ../state/<network>_run_<id>/config-bootstrap.json [--build-only]
  npm run cli -- payment-hook:bootstrap --protocol-state ../state/<network>_run_<id>/config-bootstrap.json [--build-only]
  npm run cli -- payment-hook:update --input ../state/<network>_run_<id>/hook-updates/payment-hook-update.json --protocol-state ../state/<network>_run_<id>/config-bootstrap.json [--build-only]
  npm run cli -- receiver:parameterize --protocol-state ../state/<network>_run_<id>/config-bootstrap.json --client-state ../state/<network>_run_<id>/clients/client-a.json
  npm run cli -- reference-scripts:publish-client --protocol-state ../state/<network>_run_<id>/config-bootstrap.json --client-state ../state/<network>_run_<id>/clients/client-a.json [--build-only]
  npm run cli -- receiver:bootstrap --protocol-state ../state/<network>_run_<id>/config-bootstrap.json --client-state ../state/<network>_run_<id>/clients/client-a.json [--build-only]
  npm run cli -- update --intent ../state/<network>_run_<id>/intents/usdc-usd.signed.json --protocol-state ../state/<network>_run_<id>/config-bootstrap.json --client-state ../state/<network>_run_<id>/clients/client-a.json --pair-state ../state/<network>_run_<id>/clients/client-a/pairs/usdc-usd.json [--build-only] [--fold-deposits]
  npm run cli -- config:update --input ../state/<network>_run_<id>/config-updates/config-update.json --protocol-state ../state/<network>_run_<id>/config-bootstrap.json [--build-only]
  npm run cli -- update:batch:create [--pairs-dir ../state/<network>_run_<id>/clients/client-a/pairs] [--intents-dir ../state/<network>_run_<id>/intents] [--out ../state/<network>_run_<id>/update-batches/update-batch.manifest.json]
  npm run cli -- update:batch --protocol-state ../state/<network>_run_<id>/config-bootstrap.json --client-state ../state/<network>_run_<id>/clients/client-a.json --manifest ../state/<network>_run_<id>/update-batches/update-batch.manifest.json [--build-only] [--out ../state/<network>_run_<id>/update-batches/update-batch.result.json]
  npm run cli -- receiver:top-up --amount-lovelace 5000000 --protocol-state ../state/<network>_run_<id>/config-bootstrap.json --client-state ../state/<network>_run_<id>/clients/client-a.json [--build-only]
  npm run cli -- receiver:withdraw --amount-lovelace 2000000 [--recipient-address <addr>] --protocol-state ../state/<network>_run_<id>/config-bootstrap.json --client-state ../state/<network>_run_<id>/clients/client-a.json [--build-only]
  npm run cli -- receiver:update-min-utxo --new-min-utxo-lovelace 3000000 --protocol-state ../state/<network>_run_<id>/config-bootstrap.json --client-state ../state/<network>_run_<id>/clients/client-a.json [--build-only]
  npm run cli -- pair:update-min-utxo --new-min-utxo-lovelace 3000000 --protocol-state ../state/<network>_run_<id>/config-bootstrap.json --client-state ../state/<network>_run_<id>/clients/client-a.json --pair-state ../state/<network>_run_<id>/clients/client-a/pairs/usdc-usd.json [--build-only]
  npm run cli -- pair:burn --protocol-state ../state/<network>_run_<id>/config-bootstrap.json --client-state ../state/<network>_run_<id>/clients/client-a.json --pair-state ../state/<network>_run_<id>/clients/client-a/pairs/usdc-usd.json [--build-only]
  npm run cli -- pair:dedup --protocol-state ../state/<network>_run_<id>/config-bootstrap.json --client-state ../state/<network>_run_<id>/clients/client-a.json [--build-only]
  npm run cli -- settle --protocol-state ../state/<network>_run_<id>/config-bootstrap.json --client-state ../state/<network>_run_<id>/clients/client-a.json [--client-state ../state/<network>_run_<id>/clients/client-b.json ...] [--build-only]
  npm run cli -- deposit:address --protocol-state ../state/<network>_run_<id>/config-bootstrap.json --client-state ../state/<network>_run_<id>/clients/client-a.json
  npm run cli -- deposit:fund --amount-lovelace 5000000 --protocol-state ../state/<network>_run_<id>/config-bootstrap.json --client-state ../state/<network>_run_<id>/clients/client-a.json [--build-only]
  npm run cli -- deposit:merge --protocol-state ../state/<network>_run_<id>/config-bootstrap.json --client-state ../state/<network>_run_<id>/clients/client-a.json [--build-only]
  npm run cli -- payment-hook:withdraw --amount-lovelace 2000000 --protocol-state ../state/<network>_run_<id>/config-bootstrap.json [--build-only]
  npm run cli -- receiver:burn --protocol-state ../state/<network>_run_<id>/config-bootstrap.json --client-state ../state/<network>_run_<id>/clients/client-a.json [--build-only]
        (teardown: requires receiver balance == 0 AND accrued == 0 — run receiver:withdraw then settle first)
  npm run cli -- payment-hook:burn --protocol-state ../state/<network>_run_<id>/config-bootstrap.json [--build-only]
        (teardown: requires hook accrued_fees == 0 — run payment-hook:withdraw first)
  npm run cli -- config:burn --protocol-state ../state/<network>_run_<id>/config-bootstrap.json [--build-only]
        (teardown: final step — burns the singleton Config NFT, no value precondition)
  npm run cli -- reclaim-reference-script --script <config|payment-hook> --protocol-state ../state/<network>_run_<id>/config-bootstrap.json [--build-only]
  npm run cli -- reclaim-reference-script --script client --protocol-state ../state/<network>_run_<id>/config-bootstrap.json --client-state ../state/<network>_run_<id>/clients/client-a.json [--build-only]`);
}
...
async function run(): Promise<void> {
  ...
  switch (command) {
    ...
    case "reference-holder": {
      const { getDefaultConfigStatePath, readConfigState } = await import("./core/state.js");
      const statePath =
        optionalFlagValue("--protocol-state") ?? getDefaultConfigStatePath();
    ...
    case "intent:create": {
      ...
      const result = await createPreviewOracleIntent({
        statePath: optionalFlagValue("--protocol-state"),
    ...
    case "pair:update-min-utxo": {
      ...
      getCliConfig();
      const statePath = optionalFlagValue("--pair-state");
      const buildOnly = hasBuildOnlyFlag();
    ...
    case "update": {
      ...
      const statePath = optionalFlagValue("--pair-state");
      if (!statePath) {
        throw new Error("Missing required argument: --pair-state <path>");
      }
      const buildOnly = hasBuildOnlyFlag();
    ...
    case "reclaim-reference-script": {
      ...
      if (scriptArg === "config" || scriptArg === "payment-hook") {
        const statePath = requireFlagValue("--protocol-state");
      ...
      if (scriptArg === "client") {
        ...
        const statePath = requireFlagValue("--client-state");
