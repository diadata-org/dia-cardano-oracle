...
> **Archived 2026-06-18.** This cross-workstream master plan (A–F) is kept as the
> historical record of the contract / CLI / feeder work delivered in M1 and M2. Active,
> milestone-facing planning now lives in [`../m3-plan.md`](../m3-plan.md) and
> [`../m4-plan.md`](../m4-plan.md). Delivered milestones are recorded in their PoAs
> (`milestone-1-poa.md`, `milestone-2-poa.md`).
