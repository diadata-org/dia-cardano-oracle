...
> **Archived 2026-06-18.** This combined view was split into two milestone-facing plans:
> [`../m3-plan.md`](../m3-plan.md) and [`../m4-plan.md`](../m4-plan.md), each verified
> against the current tree. Kept for history only.
